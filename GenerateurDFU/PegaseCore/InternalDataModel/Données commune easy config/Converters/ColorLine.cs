...
namespace JAY.Converters
{
    ...
    ///                         Entreprise :
    /// </summary>
    public class ColorLine : IValueConverter
    {
        ...
        public object Convert ( object value, Type targetType, object parameter, System.Globalization.CultureInfo culture )
        {
            ...
            {
                // ligne paire
                Result = new SolidColorBrush(Color.FromArgb(0xFF, 0XB0, 0XB0, 0XB0));
            }
            else
            {
                // ligne impaire
                Result = new SolidColorBrush(Color.FromArgb(0xFF, 0x90, 0x90, 0x90));
            }
            return Result;
        }
