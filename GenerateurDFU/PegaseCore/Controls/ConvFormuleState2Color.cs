...
namespace JAY.PegaseCore
{
    ...
    ///                         Entreprise :
    /// </summary>
    public class ConvFormuleState2Color : IValueConverter
    {
        ...
        public object Convert( object value, Type targetType, object parameter, System.Globalization.CultureInfo culture )
        {
            ...
            if ( value is FormuleState )
            {
                Value = (FormuleState)value;

                switch (Value)
                {
                    case FormuleState.NON_EVALUEE:
                        Result = new SolidColorBrush(Color.FromArgb(255, 255, 224, 115)); 
                        break;
                    case FormuleState.ERREUR:
                        Result = new SolidColorBrush(Color.FromArgb(255, 255, 60, 00));
                        break;
                    case FormuleState.OK:
