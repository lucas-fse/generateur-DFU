...
namespace GenerateurDFUSafir.Models.DAL
{
 ...
 FROM [CLTPROD].[MFGITM] [MFGITM]
			...
			else if (Nmrstring == 10)
            {
				...
				//				ITMMASTER.LOTMGTCOD_0
				//  FROM[CLTPROD].MFGITM MFGITM
				//  left join[CLTPROD].[MFGMAT] MFGMAT
				//on MFGITM.[MFGNUM_0] = MFGMAT.[MFGNUM_0]
				//  left join CLTPROD.ITMMASTER ITMMASTER
				//  on ITMMASTER.ITMREF_0 = MFGMAT.ITMREF_0


				//  where ITMMASTER.TCLCOD_0 in ('PF01', 'PF02', 'PF03', 'PDR01', 'PFST1', 'PFA01') and MFGMAT.[MATSTA_0] != 4 and MFGITM.MFGNUM_0 = '" + nmrof + "'";
				return @"
SELECT TOP (1000) 
MFGITM.MFGNUM_0,
MFGITM.VCRNUMORI_0,
...
left join[CLTPROD].[MFGMAT] MFGMAT
on MFGITM.[MFGNUM_0] = MFGMAT.[MFGNUM_0]
and ITMMASTER.ITMREF_0 = MFGMAT.ITMREF_0
where  BOMD.[BOMALT_0] = '1' and BOMD.BOMALTTYP_0 = '2'  and MFGMAT.[MATSTA_0] != 4 and  (BOMD.BOMENDDAT_0 >= MFGITM.CREDAT_0 or BOMD.BOMENDDAT_0 = '1753-01-01')  and
	ITMMASTER.TCLCOD_0 in ('PF01','PF02','PF03','PDR01','PFST1','PFA01') and MFGITM.MFGNUM_0 = '" + nmrof + "'";
