...
namespace InitFile
{
    public class IniFile
    {
        ...
        public IniFile(string fileName, Encoding coding)
        {
            sFileName = fileName;

            if (File.Exists(fileName))
                Load(fileName, coding);
        }
        ...
        public void Load(string fileName, Encoding coding)
        {
            Sections = new Hashtable();

            StreamReader str = new StreamReader(File.Open(fileName, FileMode.Open, FileAccess.Read), coding);
